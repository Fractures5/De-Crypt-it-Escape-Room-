...
public class MediumPauseBGAudio : MonoBehaviour
{
    ...
    public static float pauseBGMusicVolume = 1f;
    ...
    void Update()
    {
        ...
        AudioSource.volume = pauseBGMusicVolume;
        // The slider will be updated based on the value of the background music volume level.
        bgMusicSlider.GetComponent<Slider>().value = pauseBGMusicVolume;
