...
public class PauseBGMusic : MonoBehaviour
{
    ...
    public static float pauseBGvolume = 1f;
    ...
    void Update()
    {
        ...
        AudioSource.volume = pauseBGvolume; 
        // The slider will be updated based on the value of the background music volume level.
        bgMusicSlider.GetComponent<Slider>().value = pauseBGvolume; 
